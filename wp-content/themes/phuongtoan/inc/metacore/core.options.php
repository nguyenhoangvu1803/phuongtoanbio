...
class ZoCoreControl
{
        ...
        <div class="images-field clearfix">
            ...
            foreach ($selected as $value):
                ...
                <li class="items" data-id="<?php echo esc_attr($value); ?>" style="background-image:url(<?php echo esc_url($attachment_image[0]);?>);background-size:cover;">
                    <i class="edit dashicons dashicons-plus-alt" title="<?php esc_html_e('Replace Image', 'brando'); ?>"></i>
                    <i class="remove dashicons dashicons-dismiss" title="<?php esc_html_e('Remove Image', 'brando'); ?>"></i>
                </li>
            <?php endif; endforeach; ?>
            <?php if($params['field'] != 'single'): ?>
                <li class="items" data-id=""><i class="add dashicons dashicons-plus-alt" title="<?php esc_html_e('Add Image', 'brando'); ?>"></i></li>
    ...
    private function social($params){
		...
		<table class="wp-list-table widefat fixed pages zo_social_team">
			<thead>
				<tr>
					<th><?php esc_html_e('Title', 'brando');?></th>
					<th><?php esc_html_e('Link', 'brando');?></th>
					<th><?php esc_html_e('Icon class', 'brando');?></th>
					<th><?php esc_html_e('Actions', 'brando');?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
				...
				<tr>
					<td colspan="3">
						<a class="button-primary" id="btn_add_social" href="javascript:void(0);"><?php esc_html_e('Add new', 'brando');?></a>
					</td>
				</tr>
			</tfoot>
			<tbody  id="the-list">
				<?php
					if(count($zo_social_team)):
						...
						<tr>
							...
							<td><a title="Click to edit this item" href="javascript:void(0)" class="zo_social"><?php esc_html_e('Edit', 'brando')?></a>|<a class="zo_social_remove" href="javascript:void(0)"><?php esc_html_e('Remove', 'brando')?></a></td>
						</tr>
						<?php endforeach;
					else: ?>
						<tr>
							<td class="zo_no_item" colspan="3"><?php esc_html_e('No item!', 'brando');?></td>
						</tr>
					<?php endif;
				?>
			</tbody>
				...
				<table class="widefat fixed pages tb_woo_countries">
					<thead>
						<tr>
							<th><?php esc_html_e('Title', 'brando');?></th>
							<th><?php esc_html_e('Link', 'brando');?></th>
							<th><?php esc_html_e('Icon', 'brando');?></th>
						</tr>
					</thead>
					<tbody>
						<tr>
