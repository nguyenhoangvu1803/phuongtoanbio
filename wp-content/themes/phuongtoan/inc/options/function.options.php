...
/* Top Bar */
$this->sections[] = array(
    'title' => __('Top Bar', 'ori'),
	'icon' => '',
	'subsection' => true,
    'fields' => array(
		array(
			'title' => __('Top Bar Sections', 'ori'),
			'subtitle' => __('Select and sort top bar sections you want to display', 'ori'),
			'id' => 'tbar_section',
			'type' => 'sortable',
			'mode' => 'checkbox',
			'options' => array(
		...
		array(
			...
			'subtitle' => __('Display languages switcher on section Information', 'ori'),
			'type' => 'switch',
			'default' => true
		),
        array(
		...
		array(
			...
			'subtitle' => 'View tab text on the editor to enter a font icon',
			'id' => 'tbar_infomation',
			'type' => 'editor',
			'default' => '<i class="fa fa-phone"></i> + 2 0106 5370701 <strong>|</strong> <i class="fa fa-envelope"></i> <a href="http://support.drupalexp.com">support.drupalexp.com</a>',
		),
		array(
            'title' => __('Information Icon Color', 'ori'),
		...
		array(
			'title' => esc_html__('Socials Style'),
			'Subtitle' => 'Select to change socials style',
			'id' => 'tb_socials_style',
			'default'     => '',
            'type'        => 'button_set',
            'options'     => array(
                ''    => esc_html__( 'Style Default', 'ori' ),
                'style-1'    => esc_html__( 'Style 1', 'ori' ),
                'style-2'    => esc_html__( 'Style 2', 'ori' ),
                'style-3'    => esc_html__( 'Style 3', 'ori' ),
            )
		)
    )
);
