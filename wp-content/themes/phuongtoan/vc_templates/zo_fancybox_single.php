<?php 
	...
	$custom_css .= '#' . esc_attr($atts['html_id']) . ' .zo-fancybox-content{';
    $custom_css .= 'text-align: ' . $atts['content_align'] . ';';
    $custom_css .= '}';
        ...
        <div class="zo-fancybox-body">
            ...
            <?php if($atts['content_item']):?>
                <div class="zo-fancybox-content">
                    ...
                    <?php
                        if($atts['link_content']=='yes'){
                            echo '<a href="' . $atts['link_url'] .'" title="'. $atts['title_item'] .'" class="zo-fancybox-link ' . $atts['link_class'] .'" target= "' .$atts['link_target'] . '">'. $atts['link_text'] .'</a>';
                        }
                    ?>
                </div>
            <?php endif;?>
