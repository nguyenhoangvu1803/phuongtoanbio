<div class="zo-carousel-fancyboxes-wraper <?php echo esc_attr($atts['template']);?>">
    <div id="<?php echo esc_attr($atts['html_id']);?>" class="zo-carousel-fancyboxes-body">
        <?php
            $columns = (isset($atts['zo_cols']))?(int)$atts['zo_cols']:1;
                    ...
                    <div class="zo-carousel-fancy-item">
                        <?php if($image_url):?>
							<div class="zo-carousel-fancy-box-image">
								<img src="<?php echo esc_attr($image_url);?>" alt="<?php echo get_the_title();?>" />
							</div>
                        <?php else:?>
                        ...
                        <?php endif;?>
                        <?php if($title):?>
                            <h3 class="text-ellipsis"><?php echo apply_filters('the_title',$title);?></h3>
                        <?php endif;?>
