        ...
        while ($posts->have_posts()) :
            ...
            <div class="zo-carousel-item <?php echo implode(' ', $groups);?>">
				...
				<div class="zo-carousel-content">
					<div class="align-left"><i class="fa fa-quote-left"></i></div>
						<?php the_content();?>
					<div class="align-right"><i class="fa fa-quote-right"></i></div>
				</div>
				<div class="zo-carousel-details">
					<div class="text-ellipsis"><?php echo '<' . $atts['title_element'] . ' class="zo-carousel-title">';?><?php the_title();?><?php echo '</' . $atts['title_element'] .'>';?></div>
