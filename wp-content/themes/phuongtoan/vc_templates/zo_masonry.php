<?php 
    ...
    /* get categories */
    $taxonomy = isset($taxonomies[0]) ? $taxonomies[0]: 'category';
    $_category = array();
                ...
                <div class="zo-masonry-inner" style="background-image: url('<?php echo esc_url($thumbnail); ?>')">
                    <div class="zo-masonry-overlay">
                        <div class="zo-masonry-overlay-inner">
                            <h2 class="zo-masonry-title text-ellipsis"><a href="<?php the_permalink(); ?>"><?php the_title();?></a></h2>
							<div class="zo-masonry-content"><?php echo zo_limit_words(get_the_content(),17);?></div>
                            <div class="zo-masonry-btn">
