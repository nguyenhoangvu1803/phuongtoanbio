<?php
    ...
    if(!empty($atts['heading_color'])){
        $custom_css .= 'color:' . $atts['heading_color'] . ';';
    }
    ...
    if(!empty($atts['sub_color'])){
        $custom_css .= 'color:' . $atts['sub_color'] . ';';
    }
...
?>
<div class="zo-heading-wraper style-light <?php echo esc_attr($atts['class']) . ' ' . esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php
