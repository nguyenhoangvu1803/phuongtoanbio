 ...
 * Background
 */
$html_overlay_row = $background_primary = $custom_overlay_color = '';
if($background_primary_color == "yes") {
	$background_primary = 'background-primary-color';
}
if(!empty($overlay_color)){
	$custom_overlay_color = 'style="background-color: ' .$overlay_color. ';"';
}
if($overlay_row == 'yes') {
    $html_overlay_row .= '<div class="zo-overlay-color '.$background_primary.'" '. $custom_overlay_color .'></div>';
