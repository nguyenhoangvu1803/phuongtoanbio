...
<!-- Header Logo -->
<div id="zo-header-logo" class="align-center style-5">
	<div class="<?php echo esc_attr($container);?>">
		<div class="row">
...
<!-- Header Navigation -->
<div id="zo-header" class="zo-main-header header-default style-5 <?php if (!$smof_data['menu_sticky']) {
	echo 'no-sticky';
	...
	<div class="<?php echo esc_attr($container);?>">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 zo-header-navigation">
