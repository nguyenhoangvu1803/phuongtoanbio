                                        ...
                                        <li class="jtwt_tweet">
                                            ...
                                            <div class="tweet_right">
                                                ...
                                                <?php if($show_date == 'yes'): ?>
                                                    <a href="http://twitter.com/<?php echo esc_attr($tweet['user']['screen_name']); ?>/statuses/<?php echo esc_attr($tweet['id_str']); ?>" class="jtwt_date"><?php esc_html_e('about','ori');?> <?php echo esc_attr($timeAgo); ?></a>
                                                <?php endif; ?>
                                            </div>
                                        </li>
                                    <?php endforeach; ?>
