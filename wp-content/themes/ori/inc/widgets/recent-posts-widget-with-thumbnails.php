...
class Zo_Recent_Posts_Widget_With_Thumbnails extends WP_Widget {
	...
	function __construct() {
        ...
        parent::__construct(
            ...
            __('Recent Posts With Thumbnails', 'ori'), // Name
            array('description' => __('List of your site&#8217;s most recent posts, with clickable title and thumbnails.', 'ori'),) // Args
        );
		...
		<?php while ( $r->have_posts() ) : $r->the_post(); ?>
			<li>
				...
				<div class="recent-detail">
					...
					<?php if ( $show_date ) : ?> 
						<div class="zo-post-date"><span><?php echo esc_html_e('Date: ', 'ori');?><?php echo get_the_date('F j, Y');?></span></div>
					<?php	endif; ?>
...
<?php
	...
	function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'ori' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'number_posts' )); ?>"><?php _e( 'Number of posts to show:', 'ori' ); ?></label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php _e( 'Display post date?', 'ori' ); ?></label></p>

		<h4><?php _e( 'Thumbnail Options', 'ori' ); ?>:</h4>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_thumb' )); ?>"><?php _e( 'Display post featured image?', 'ori' ); ?></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id( 'thumb_width' )); ?>"><?php _e( 'Width of thumbnail', 'ori' ); ?>:</label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'thumb_height' )); ?>"><?php _e( 'Height of thumbnail', 'ori' ); ?>:</label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'keep_aspect_ratio' )); ?>"><?php _e( 'Use aspect ratios of original images?', 'ori' ); ?> <em><?php _e( 'If checked the given width is used to determine the height of the thumbnail automatically. This option also supports responsive web design.', 'ori' ); ?></em></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_title' )); ?>"><?php _e( 'Do not show title?', 'ori' ); ?> <em><?php _e( 'Make sure you set a default thumbnail for posts without a thumbnail, otherwise there will be no link.', 'ori' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'try_1st_img' )); ?>"><?php _e( "Try to use the post's first image if post has no featured image?", 'ori' ); ?></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'only_1st_img' )); ?>"><?php _e( 'Use first image only, ignore featured image?', 'ori' ); ?></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'use_default' )); ?>"><?php _e( 'Use default thumbnail if no image could be determined?', 'ori' ); ?></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id( 'default_url' )); ?>"><?php _e( 'URL of default thumbnail (start with http://)', 'ori' ); ?>:</label>
