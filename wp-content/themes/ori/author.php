	...
	<section id="primary" class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="archive-header">
				<h1 class="archive-title"><?php printf( __( 'Author Archives: %s', 'ori' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
			...
			<div class="author-info">
				...
				<div class="author-description">
					<h2><?php printf( __( 'About %s', 'ori' ), get_the_author() ); ?></h2>
