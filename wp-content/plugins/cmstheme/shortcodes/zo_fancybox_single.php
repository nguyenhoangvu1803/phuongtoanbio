	...
	array(
	    ...
	    "params" => array(
            ...
            array(
                ...
                'dependency' => array(
                    'element' => 'icon_type',
                    'value' => array('linearicons','etline','openiconic','typicons','linecons','pixelicons','pe7stroke','fontawesome'),
                ),
	        ),
			array(
	            "type" => "attach_image",
	        ...
	        array(
	            "type" => "dropdown",
	            "heading" => __("Target Type",'cmstheme'),
